                ...
                <div class="card-body">
                    ...
                    <input type="hidden" name="idData" id="idData" value="{{ $res->id }}">
                        <div class="col-md-12 position-relative">
                            ...
                            <input class="form-control" id="inpMaterial" name="inpMaterial" type="text" value="{{ $res->material }}" required="">
                        ...
                        <div class="col-md-6 position-relative">
                            ...
                            <select class="form-select select" id="selectMerek" name="selectMerek" required="">
                                ...
                                @foreach ($listMerek as $merek)
                                    @if($merek['id'] === $res->merek_id)
                                    <option value="{{ $merek['id'] }}" selected>{{ $merek['merek'] }}</option>
                                    @else
                        ...
                        <div class="col-md-6 position-relative">
                            ...
                            <input class="form-control angka" id="inpHargaBeli" name="inpHargaBeli" value="{{ $res->harga_beli }}" type="text" required="">
                        </div>
                        <div class="col-md-3 position-relative">
                            <label class="form-label" for="inpStokAwal">Stok Awal</label>
                            <input class="form-control angka" id="inpStokAwal" name="inpStokAwal" value="{{ $res->stok_awal }}" type="text" maxlength="4" oninput="toStockAkhir(this)" {{ ($res->stok_akhir > 0) ? "readonly" : "" }}>
                        </div>
                        <div class="col-md-3 position-relative">
                            <label class="form-label" for="inpStokAkhir">Stok Akhir</label>
                            <input class="form-control angka" id="inpStokAkhir" name="inpStokAkhir" value="{{ $res->stok_akhir }}" type="text" maxlength="4" readonly>
                        </div>
                        <div class="col-md-12 position-relative">
                            <label class="form-label" for="inpDeskripsi">Deskripsi</label>
                            <textarea class="form-control" name="inpDeskripsi" id="inpDeskripsi">{{ $res->deskripsi }}</textarea>
                        </div>
                        <hr>
                        <div class="row justify-content-center">
                            <div class="col-md-4">
...
<script>
    $(document).ready(function () {
        ...
        $('#createForm').submit(function (e) {
            ...
            $.ajax({
                url: "{{ url('material/update') }}/"+$("#idData").val(), // Update this with your route
                type: "POST",
