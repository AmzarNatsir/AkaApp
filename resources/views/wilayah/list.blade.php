        ...
        <div class="col-sm-12">
            <div class="card">
                <div class="card-header">
                    <h4>Data Wilayah</h4><span>Daftar data wilayah</span>
                </div>
                <div class="card-body">
...
<script>
    $(document).ready(function () {
        ...
        $("#btn_add").on("click", function(){
            $("#form_view").load("{{ route('wilayah.create') }}");
        });
        $("#table_view").on('click', '#btn_edit', function(){
            $("#form_view").load("{{ url('wilayah/edit') }}/"+$(this).val());
        });
    });
    var konfirmDelete = function(el)
    {
        ...
        {
            $.ajax({
                url: "{{ url('wilayah/destroy') }}/"+$(el).val(),
                type: "GET",
