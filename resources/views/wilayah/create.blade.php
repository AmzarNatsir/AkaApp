<div class="modal-toggle-wrapper social-profile text-start dark-sign-up">
    <h3 class="modal-header justify-content-center border-0">Input data wilayah</h3>
    <div class="modal-body">
        ...
        @csrf
            <div class="col-md-12">
                ...
                <input class="form-control" id="inpNama" name="inpNama" type="text" placeholder="Masukkan nama wilayah" required="">
...
<script>
    $(document).ready(function () {
        ...
        $('#createForm').submit(function (e) {
            ...
            $.ajax({
                url: "{{ route('wilayah.store') }}", // Update this with your route
                type: "POST",
                data: $(this).serialize(),
