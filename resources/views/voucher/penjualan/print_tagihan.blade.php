    ...
    <table style="border-collapse: collapse; width: 100%;" cellpadding="3" border="1">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td style="font-size:13pt; text-align:center"><b>{{ $r->stok_terjual }}</b></td>
                <td style="text-align:right;font-size:13pt"><b>{{ number_format($total_laba, 0) }}</b></td>
            </tr>
            @php
            ...
            <tr>
                ...
                <td style="text-align:center;font-size:13pt"><b>{{ number_format($t_stok_terjual, 0) }}</b></td>
                <td style="text-align:right;font-size:13pt"><b>{{ number_format($t_laba, 0) }}</b></td>
            </tr>
        </tbody>
    </table>
</main>
