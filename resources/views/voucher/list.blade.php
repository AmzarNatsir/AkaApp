        ...
        <div class="col-sm-12">
            <div class="card">
                <div class="card-header">
                    <h4>Data Voucher</h4><span>Daftar data voucher</span>
                </div>
                <div class="card-body">
...
<script>
    $(document).ready(function () {
        ...
        $("#btn_add").on("click", function(){
            $("#form_view").load("{{ route('voucher.create') }}");
        });
        $("#table_view").on('click', '#btn_edit', function(){
            $("#form_view").load("{{ url('voucher/edit') }}/"+$(this).val());
        });
    });
    var konfirmDelete = function(el)
    {
        ...
        {
            $.ajax({
                url: "{{ url('voucher/destroy') }}/"+$(el).val(),
                type: "GET",
