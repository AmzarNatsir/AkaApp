        ...
        <div class="col-sm-12">
            <div class="card">
                <div class="card-header">
                    <h4>Data Agen Voucher</h4><span>Daftar data agen voucher</span>
                </div>
                <div class="card-body">
                        ...
                        <table class="display" id="table_view">
                          <thead>
                            <tr>
                              ...
                              <th style="width: 20%">Kontak Person</th>
...
<script>
    $(document).ready(function () {
        ...
        $("#btn_add").on("click", function(){
            $("#form_view").load("{{ route('agen.create') }}");
        });
        $("#table_view").on('click', '#btn_edit', function(){
            $("#form_view").load("{{ url('agen/edit') }}/"+$(this).val());
        });
    });
