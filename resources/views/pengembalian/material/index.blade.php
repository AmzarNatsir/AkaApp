            ...
            <div class="row">
                <div class="col-xl-3 col-sm-6">
                    <div class="card o-hidden small-widget">
                        ...
                        <button type="button" class="btn btn-lg btn-primary btn-square" name="btn_gudang_utama" id="btn_gudang_utama" value="1" onclick="goFormCreate(this)" {{ ($gudang_utama == 0) ? "disabled" : "" }}>Pilih Gudang</button>
                    </div>
                </div>
...
<script>
    ...
    {
        var gudangID = $(el).val();
        location.replace("{{ url('pengembalianMaterial/baru') }}/"+gudangID);
    }
</script>
@endsection
