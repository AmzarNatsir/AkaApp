                ...
                <div class="col-md-12 project-list">
                    <div class="card">
                        <div class="card-header border-b-info total-revenue">
                            ...
                            @can("trans_keuangan_kas_keluar_create")
...
<script>
    $(document).ready(function () {
        ...
        var tableAjax = $("#list_transaksi").DataTable({
            ...
            autoWidth: true,
            ajax: {
                url: "{{ route('keuangan.kasKeluar.getData') }}",
                type: "post",
                headers : {
        ...
        $("#btn_add").on("click", function(){
            $("#form_view").load("{{ route('keuangan.kasKeluar.baru') }}");
        });
    ...
    var editData = function(el)
    {
        var idItem = el;
        // alert(idItem);
        $("#form_view").load("{{ url('keuangan/kasKeluarEdit') }}/"+idItem, function(){
            $(".angka").number(true, 0);
        });
    }
    var konfirmDelete = function(el)
    {
        ...
        {
            $.ajax({
                url: "{{ url('keuangan/kasKeluarDelete') }}/"+el,
                type: "GET",
                success:function(response){
                    if(response.success==true) {
                        swal('Success! '+response.message, {
                            ...
                            location.replace("{{ route('keuangan.kasKeluar.daftar') }}");
