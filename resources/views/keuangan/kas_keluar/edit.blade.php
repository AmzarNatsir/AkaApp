<div class="modal-toggle-wrapper social-profile text-start dark-sign-up">
    <h3 class="modal-header justify-content-center border-0">Edit Kas Keluar</h3>
    <div class="modal-body">
        ...
        {{ method_field('PUT') }}
            ...
            <input type="hidden" name="idkasKeluar" id="idkasKeluar" value="{{ $res->id }}">
            <div class="col-sm-6">
                <div class="mb-3">
...
<script>
    $(document).ready(function () {
        ...
        $('#updateForm').submit(function (e) {
            var idHead = $("#idkasKeluar").val();
            e.preventDefault(); // Prevent default form submission
            $.ajax({
                url: "{{ url('keuangan/kasKeluarUpdate') }}/"+idHead, // Update this with your route
                type: "POST",
                data: $(this).serialize(),
